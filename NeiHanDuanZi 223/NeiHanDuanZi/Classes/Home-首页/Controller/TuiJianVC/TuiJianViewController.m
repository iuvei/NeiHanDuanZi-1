...
//  内涵App
//
//  Created by ibokan2 on 2016/11/16.
...
- (void)beginNetworkRequest {
    ...
    NSString *urlString = @"http://ic.snssdk.com/neihan/stream/mix/v1/?content_type=-101";
...
- (void)loadNewData {
    ...
    NSString *urlString = @"http://lf.snssdk.com/neihan/stream/mix/v1/?content_type=-101&iid=6313378117&os_version=10.0&os_api=18&app_name=joke_essay&channel=App%20Store&device_platform=iphone&idfa=BE8C5831-482D-43E9-9A6E-B5E97EDA7583&live_sdk_version=130&vid=9E81C4DD-570F-4E4B-86B2-06045DCF3C23&openudid=b108c8e2cddf068f234207f72c5859321f81a13a&device_type=iPhone8,1&version_code=5.7.1&ac=WIFI&screen_width=750&device_id=34160507909&aid=7&city=%E5%B9%BF%E4%B8%9C%E7%9C%81&content_type=-101&count=30&essence=1&latitude=23.13521020790215&longitude=113.2495182772486&message_cursor=0&min_time=1480375199&mpic=1";
    [AFNetworkingRequest getRequestWithUrl:urlString result:^(id result) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    _commentStr = [NSString stringWithFormat:@"%@=%ld%@",str2,[groupID integerValue],str3];
    
    DetailViewController *detailVC = [DetailViewController new];
    detailVC.commentStr = self.commentStr;
    detailVC.groupDic = self.dic;
